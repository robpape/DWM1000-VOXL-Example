...
#include "../../boards/voxl_dw1000.h"
#include <voxl_io.h>
// #include <voxl_gpio.c> // to write/read pins in reset_DW1000; there does not seem to be a header file
...
#define VOXL_SPI_BUS 9
#define VOXL_SPI_BUS_MODE 0
#define VOXL_SPI_FREQ 2000000
...
#define SPI_CS_PIN   SPIS_CSN_PIN /**< SPI CS Pin.*/
// #else
